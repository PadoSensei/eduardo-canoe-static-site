...
export const TourCardSkeleton = () => (
  <div data-testid="skeleton-tour-card" className="flex flex-col items-center gap-6 p-5 border-b last:border-b-0 animate-pulse sm:flex-row">
...
export const PassengerRowSkeleton = () => (
  <div data-testid="skeleton-passenger-row" className="p-4 mb-3 border border-gray-100 rounded-xl flex items-center justify-between animate-pulse bg-white">
...
export const DayManifestTourCardSkeleton = () => (
  <div data-testid="skeleton-manifest-tour-card" className="p-5 bg-white border border-gray-100 rounded-xl animate-pulse">
