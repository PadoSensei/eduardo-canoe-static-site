...
export const translations = {
  en: {
    ...
    admin_manual_booking_done: "Done",
    aria_manifest_checkin_toggle: "Check-in Toggle",
    aria_status_confirmed: "Status: Payment Confirmed",
    aria_status_onboard: "Status: On Board",
    aria_modal_close: "Close modal",
    aria_add_guest: "Add passenger manually",
  },
  ...
  pt: {
    ...
    admin_manual_booking_pax: "Pax",
    admin_manual_booking_done: "Concluído",
    aria_manifest_checkin_toggle: "Alternar Check-in",
    aria_status_confirmed: "Status: Pagamento Confirmado",
    aria_status_onboard: "Status: A Bordo",
    aria_modal_close: "Fechar modal",
    aria_add_guest: "Adicionar passageiro manualmente",
  },
  ...
  es: {
    ...
    admin_manual_booking_pax: "Pax",
    admin_manual_booking_done: "Listo",
    aria_manifest_checkin_toggle: "Alternar Check-in",
    aria_status_confirmed: "Estado: Pago Confirmado",
    aria_status_onboard: "Estado: A Bordo",
    aria_modal_close: "Cerrar modal",
    aria_add_guest: "Agregar pasajero manualmente",
  },
  fr: {
    // --- Navigation ---
    navHome: "Accueil",
    ...
    admin_manual_booking_pax: "Pax",
    admin_manual_booking_done: "Terminé",
    aria_manifest_checkin_toggle: "Bascule d'enregistrement",
    aria_status_confirmed: "Statut : Paiement Confirmé",
    aria_status_onboard: "Statut : À Bord",
    aria_modal_close: "Fermer la modal",
    aria_add_guest: "Ajouter un passager manuellement",
  },
};
