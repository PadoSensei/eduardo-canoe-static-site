...
export const translations = {
  en: {
    ...
    placeholderPhone: "+55 (84) 99999-9999",
    ...
    alertMissing: "Please provide name, email, and phone number.",
  ...
  pt: {
    ...
    labelPhone: "Telefone",
    placeholderPhone: "(84) 99999-9999",
    ...
    alertMissing: "Por favor, forneça nome, e-mail e telefone.",
  ...
  es: {
    ...
    alertMissing: "Por favor proporcione nombre, correo y teléfono.",
  ...
  fr: {
    ...
    alertMissing: "Veuillez fournir un nom, un email et un numéro de téléphone.",
